...
class WBU_Shop {
    function init_hooks() {
        ...
        add_action('flatsome_product_box_after', array($this, 'flatsome_shop_quantity_buttons') );
    ...
    function flatsome_shop_quantity_buttons()
    {
        global $product;
        
        if ( $this->product_allowed_change_qty($product) ) {
            echo $this->shop_build_quantity_area_html($product);
        }
    }
